...
def HeatMap(data, name, scale, variable, vmin=None, vmax=None, color=None, fmt=".1f", cmap='viridis'):
    """
...
# HeatMap(data2, 'NPV_HeatMap', scale=1000, variable='NPV', vmin=-30.0, vmax=220, color='black', fmt=".1f", cmap='viridis_r')#, cmap=custom_cmap)
